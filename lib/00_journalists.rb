...
# Handle contiennent un numéro:
    puts "\n" + "=========================" + "\n" + "Handle contiennent un numéro" + "\n" + "========================="
    nbr = journalists.select{ |x| x =~ /[0-9]/}
    puts (nbr.count())
    puts "\n"

# Handle contiennent les 4 lettres du prénom "Aude" à la suite
    puts "\n" + "=========================" + "\n" + "Handle contiennent les 4 lettres (AUDE)" + "\n" + "========================="
    nbr = journalists.select{ |x| x =~ /(:?A|a)(:?U|u)(:?D|d)(:?E|e)/}
    puts (nbr.count())  
    puts "\n"  

# Commence par une Majuscule
    puts "\n" + "=========================" + "\n" + "Commence par une lettre Majuscule" + "\n" + "========================="
    nbr = journalists.select{ |x| x =~ /@[A-Z]/}
    puts (nbr.count())
    puts "\n"

# Qui contienne des majuscule
    puts "\n" + "=========================" + "\n" + "Qui contiennent des majuscules" + "\n" + "========================="
    nbr = journalists.select{ |x| x =~ /[A-Z]/}
    puts (nbr.count())
    puts "\n"

# Qui contient _ dans les pseudos
    puts "\n" + "=========================" + "\n" + "Qui contiennent (_)" + "\n" + "========================="
    nbr = journalists.select{ |x| x =~ /(.*)_(.*)/}
    puts (nbr.count())
    puts "\n"
...
# 50 Handle les plus courtes
    puts "\n" + "=========================" + "\n" + "50 Handle les plus courtes" + "\n" + "========================="
    list = journalists.sort_by(&:size).first(50)
    puts list
    puts "\n"

# Position de @epenser dans l'array
    puts "\n" + "=========================" + "\n" + "Position de @epenser est:" + "\n" + "========================="
